export const meta = {
  name: 'audit-ai-llm-zh-cn',
  description: 'Audit Simplified Chinese (zh-CN/) pages for AI/LLM structured data gaps and apply JSON-LD fixes',
  whenToUse: 'Run after adding new Simplified Chinese pages, or use audit-ai-llm-all to audit all languages at once.',
  phases: [
    { title: 'Discover', detail: 'Find all auditable HTML pages under zh-CN/' },
...
const LANG_DIR = 'zh-CN'
const LANG_LABEL = 'Simplified Chinese (zh-CN/)'
  ...
  properties: {
    pages: {
      ...
      items: {
        type: 'object',
        properties: {
          file: { type: 'string', description: 'Relative path from repo root, e.g. zh-CN/about-sifu-angus.html' },
...
This page is in Simplified Chinese (简体中文).
...
- WebSite (index): @type WebSite — name, url, inLanguage "zh-CN", potentialAction SearchAction
...
Summarize this AI/LLM structured data audit for Simplified Chinese (zh-CN/) pages of a Kung Fu school website.

Results JSON:
${JSON.stringify(filtered, null, 2)}

Write a concise markdown report with:
## Results (Simplified Chinese / zh-CN/)
